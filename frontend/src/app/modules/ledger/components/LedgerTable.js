              ...
              ledgerData.map((row) => {
                ...
                return (
                  <React.Fragment key={rowId}>
                    {/* Main Row */}
                    <tr
                      className={`transition-colors group ${editingId === rowId ? "bg-blue-50/50" : "hover:bg-slate-50/50"}`}
                    >
                          ...
                          <div className="pl-14 pr-6 py-4 animate-in slide-in-from-top-2 fade-in duration-200 min-h-[80px]">
                            ...
                            {isLoadingDetails ? (
                              ...
                              <>
                                ...
                                {expandedDetails.paymentsReceived &&
                                  expandedDetails.paymentsReceived.length >
                                    0 && (
                                    <div className="bg-white border border-slate-200 rounded-xl p-4">
                                      ...
                                      <div className="space-y-2">
                                        {expandedDetails.paymentsReceived.map(
                                          (payment, idx) => {
                                ...
                                {expandedDetails.allocations &&
                                  expandedDetails.allocations.length > 0 && (
                                    <div className="bg-white border border-slate-200 rounded-xl p-4">
                                      <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-3 border-b border-slate-100 pb-2">
                                        Invoices Cleared by this Payment
                                      </h4>
                                      <div className="space-y-2">
                                        {expandedDetails.allocations.map(
                                          (alloc, idx) => {
